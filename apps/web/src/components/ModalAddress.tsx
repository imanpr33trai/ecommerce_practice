      ...
      <div className="relative bg-white rounded-[2rem] shadow-2xl w-full max-w-lg overflow-hidden animate-slide-up">
        ...
        <div className="p-6 md:p-8 space-y-4 max-h-[70vh] overflow-y-auto">
           <div>
              ...
              <input type="text" placeholder="e.g. Home, Work" className="w-full bg-gray-50 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-black/5 outline-none" />
           </div>

           <div className="grid grid-cols-2 gap-4">
             <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">First Name</label>
                <input type="text" className="w-full bg-gray-50 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-black/5 outline-none" />
             </div>
             <div>
           ...
           <div>
              ...
              <input type="text" placeholder="123 Main St" className="w-full bg-gray-50 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-black/5 outline-none mb-2" />
              <input type="text" placeholder="Apt, Suite, Unit (Optional)" className="w-full bg-gray-50 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-black/5 outline-none" />
           </div>
        ...
        <div className="p-6 bg-gray-50 border-t border-gray-100 flex gap-3">
           ...
           <Button className="flex-1" onClick={onClose}>Save Address</Button>
        </div>
