...
const ModalCompare: React.FC = () => {
  const { compareList, isCompareOpen, setCompareOpen, removeFromCompare } =
    useShop();
      ...
      <div className="relative bg-white rounded-[2rem] shadow-2xl w-full max-w-6xl h-[85vh] overflow-hidden animate-slide-up flex flex-col">
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <h2 className="text-2xl font-light">
            Compare Products{" "}
            <span className="text-gray-400">({compareList.length})</span>
          </h2>
          <button
            onClick={() => setCompareOpen(false)}
          ...
          <div className="flex-1 overflow-auto p-8">
            <div className="grid grid-cols-1 md:grid-cols-4 min-w-[800px]">
              <div className="col-span-1 pr-8 space-y-8 pt-[320px] hidden md:block">
                <div className="h-12 flex items-center font-bold text-gray-500">
                  Price
                </div>
                <div className="h-12 flex items-center font-bold text-gray-500">
                  Rating
                ...
                <div className="h-24 flex items-center font-bold text-gray-500">
                  Description
                </div>
                <div className="h-12 flex items-center font-bold text-gray-500">
                  Materials
              ...
              {compareList.map((product) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold mb-8 truncate">
                    {product.name}
                  </h3>
