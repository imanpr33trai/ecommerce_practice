...
import { ProductFilterSchema, type ProductFilters, type ProductSingle } from "@/feature/product/types";
...
function useLocalStorage<T>(key: string, initialValue: T) {
  // Initialize with standard initialValue to match Server HTML
...
export const ShopProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [filters, setFilters] = useState<ProductFilters>(ProductFilterSchema.parse({}));
  ...
  const resetFilters = useCallback(() => {
    setFilters(ProductFilterSchema.parse({}));
  }, []);

  // biome-ignore lint/nursery/noShadow: <aithe kuchh nhi hunda>
