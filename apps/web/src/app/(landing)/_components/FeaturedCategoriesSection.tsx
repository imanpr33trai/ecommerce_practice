...
const FeaturedCategoriesSection = () => {
	...
	const CategoryCard = ({
		...
		<Card
			className={`group relative flex h-full w-full items-end overflow-hidden rounded-3xl ${className}`}
		>
			...
			<div className="relative z-10 p-6 text-white md:p-8">
				<h3
					className={`${isLarge ? "text-3xl md:text-4xl" : "text-2xl"} font-bold`}
				>
					{title}
				</h3>
				...
				<Button
					...
					href={href}
					variant="secondary"
					className="mt-4 rounded-full bg-white/90 text-black hover:bg-white"
				>
					Explore
	...
	return (
		<section className="min-h-screen bg-background py-16 dark:bg-zinc-900">
			<MaxWidthWrapper>
				<div className="mb-12 text-center">
					...
					<p className="mx-auto mt-4 max-w-xl text-muted-foreground">
						Find exactly what you need by exploring our curated furniture
						categories.
					</p>
				</div>

				{/* Asymmetrical Grid inspired by the hero section */}
				<div className="grid h-[600px] grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
					<CategoryCard
