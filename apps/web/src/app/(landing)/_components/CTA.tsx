...
const FinalCTASection = () => {
	return (
		<section className="bg-background pb-16 dark:bg-zinc-900">
			<MaxWidthWrapper>
				<Card className="group relative flex min-h-[400px] w-full items-center justify-center overflow-hidden rounded-3xl text-center">
					...
					<div className="relative z-10 flex flex-col items-center p-8 text-white">
						<h2 className="font-extrabold text-4xl tracking-tight sm:text-5xl">
							Design Your Perfect Space
						</h2>
						<p className="mt-6 max-w-xl text-lg text-white/90">
							You've seen our commitment to quality and design. Now it's time to
							bring it home. Explore our full collection and find the pieces
