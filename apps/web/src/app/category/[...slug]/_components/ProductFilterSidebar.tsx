...
import { SubCategoryList } from "@/types/index";
...
interface ProductFiltersSidebarProps {
  ...
  initialSubcategories: SubCategoryList;
  isLoading: boolean;
  isError: boolean;
}
  ...
  return (
    <aside className="hidden lg:block">
      <div className="space-y-8">
        ...
        {/* Color Filter */}
        {initialSubcategories &&
          initialSubcategories.children &&
          initialSubcategories.children.length > 0 && (
            <div>
              <h3 className="mb-4 font-bold text-foreground text-lg">
                Subcategory
              </h3>
              <div className="space-y-2">
                {initialSubcategories.children.map((child) => (
                  <div
                    key={child.id}
