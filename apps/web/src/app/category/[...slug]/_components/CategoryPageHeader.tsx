...
const CategoryHeader = ({ slugs }: { slugs: string[] }) => {
	...
	return (
		<div className="mb-8">
				...
				{slugs.map((segment, index) => {
					...
					return (
						...
						<div key={fullPathForLink} className="flex items-center">
							...
							{/* Only show chevron if it's not the first segment and NO base categories link */}
							{isLast ? (
			...
			<h1 className="mt-4 font-extrabold text-4xl tracking-tight">
